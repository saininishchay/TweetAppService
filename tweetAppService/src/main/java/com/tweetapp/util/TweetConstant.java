...
public class TweetConstant {
	...
	public static final String USER_NAME_REGISTERED_SUCCESSFULLY = "UserName Registered Successfully";
	public static final String USER_NAME_ALREADY_EXIST = "User Already Exist";
	public static final String LOGIN_SUCCESS = "Login Success";
	public static final String LOGIN_FAILED = "Login Failed: incorrect userName or password";
